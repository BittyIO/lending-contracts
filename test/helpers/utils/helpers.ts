...
export const getReserveData = async (
  helper: BittyProtocolDataProvider,
...
export const getNftData = async (helper: BittyProtocolDataProvider, nftAsset: tEthereumAddress): Promise<NftData> => {
...
const getBTokenUserData = async (reserve: string, user: string, dataProvider: BittyProtocolDataProvider) => {
